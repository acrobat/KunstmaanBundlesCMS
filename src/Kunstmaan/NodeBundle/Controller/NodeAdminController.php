...
class NodeAdminController extends Controller
{
    ...
    /**
     * @Route(      "/{id}/revert", requirements={"id"="\d+"}, defaults={"subaction":"public"},      name="KunstmaanNodeBundle_nodes_revert", methods={"GET"} )
     *
     * @param Request $request
     * @param int     $id      The node id
     *
    ...
    /**
     * @Route(      "/{id}/{subaction}", requirements={"id"="\d+"}, defaults={"subaction":"public"},      name="KunstmaanNodeBundle_nodes_edit", methods={"GET", "POST"}      )
