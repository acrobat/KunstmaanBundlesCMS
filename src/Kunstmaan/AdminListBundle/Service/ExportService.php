...
class ExportService
{
    ...
    {
        if (null === $twig) {
            //Trigger deprecation as parameter will be required
    ...
    /**
     * @deprecated Setter injection is deprecation since KunstmaanAdminListBundle 5.4 and will be removed in KunstmaanAdminListBundle Use constructor injection instead.
